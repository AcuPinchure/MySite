...
class Command(BaseCommand):
    def weeklySummary(self, name):
        ...
        oldest_post_time = Tweet.objects.filter(media__seiyuu__name=search,analyzed=False).earliest('post_time').post_time
        ...
        while current_sunday <= newest_saturday:
            ...
            if tweets.exists():
                ...
                self.stdout.write(self.style.SUCCESS(f'Created WeeklyStats for {stats}'))
